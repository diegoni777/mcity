                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="product-detail.html" class="nav-item nav-link active">Ofertas</a>
                            <a href="cart.html" class="nav-item nav-link">Carrito</a>
                            <a href="checkout.html" class="nav-item nav-link">Mi direccion</a>
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="wishlist.html" class="dropdown-item">Lista de deseados</a>
                                    <a href="login.html" class="dropdown-item">Login & Registro</a>
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Productos En OFERTA</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        <div class="title"><h2>Coleccion verano (varias marcas)</h2></div>
                                        <div class="ratting">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content">
                                    <div id="description" class="container tab-pane active">
                                        <h4>Descripcion</h4>
                                        <p>
                                            Llego la nueva coleccion para verano con nuevas prendas de dieferente color y tamaño para todos los gustos de todas las personas no te quedes sin las tuya porque se eestan acabando
                                        </p>
                                    </div>
                                    <div id="specification" class="container tab-pane fade">
                                        <h4>Product specification</h4>
                                        <ul>
                                            <li>Vestido corto de jala</li>
                                            <li>Vestido de playa</li>
                                            <li>Camisa de caballero</li>
                                    ...
                                    <div id="reviews" class="container tab-pane fade">
                                        <div class="reviews-submitted">
                                            ...
                                            <p>
                                                Ropa muy coomoda y barata ademas por su precio me parece de buena calidad
                                            </p>
                                        </div>
